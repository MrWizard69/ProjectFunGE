			 ...
			 movement: function(){
				 ...
				 //this will make direct the enemy move in the direction of the player at varying speeds and times
				  if(this.x < x && this.y < y){
					 ...
					 //this.x += 1;
					 //this.y += 1;
					 this.x += (canvas.width) * 0.003;
					 this.y += (canvas.height) * 0.003;
				 }
				 if(this.x > x && this.y > y){
